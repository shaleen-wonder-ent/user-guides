...
> 📎 *All feature details are based on Microsoft's official Entra ID documentation and current licensing terms as of May 2026. Guest usage pricing is subject to Microsoft's External ID MAU billing model — refer to the [Microsoft External ID pricing page](https://azure.microsoft.com/en-us/pricing/details/active-directory/external-identities/) for current rates.*
